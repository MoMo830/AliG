...
TRANSLATIONS = {
    "English": {
        "onboarding": {
            ...
            "ptr_github_desc": "Github button — follow latest updates and releases.",
    ...
    "Français": {
        "onboarding": {
            ...
            "ptr_github_desc": "Bouton Github — suivez les dernières mises à jour et versions.",
    ...
    "Deutsch": {
        "onboarding": {
            ...
            "ptr_github_desc": "Github-Schaltfläche — verfolgen Sie die neuesten Updates und Versionen.",
